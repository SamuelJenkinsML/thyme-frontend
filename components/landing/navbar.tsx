    ...
    <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-white/70 border-b border-[#e0e0e0]/50">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 font-[var(--font-dm-sans)]">
          ...
          <button className="bg-[#2E5A1C] text-white px-5 py-2 rounded-full hover:bg-[#3d7425] transition-colors text-[0.95rem]">
            Book a Demo
          </button>
        </div>
      ...
      {open && (
        <div className="md:hidden bg-white/95 backdrop-blur-md border-b border-[#e0e0e0] px-6 pb-6 pt-2 flex flex-col gap-4 font-[var(--font-dm-sans)]">
          ...
          <button className="bg-[#2E5A1C] text-white px-5 py-3 rounded-full mt-2">Book a Demo</button>
        </div>
      )}
    </nav>
  );
