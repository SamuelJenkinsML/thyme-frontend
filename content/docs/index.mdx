...
<Tabs items={["Consistency", "No Infra Ops", "Sub-second Freshness"]}>
<Tab value="Consistency">
...
<Card title="Why Thyme?" href="/docs/why-thyme" />
</Cards>
