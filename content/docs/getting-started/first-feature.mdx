...
```bash
# Send all definitions to your Thyme instance
...
Your hosted Thyme instance creates Kafka topics and persists the execution plan. The engine picks up the new job within seconds and begins consuming from the source.
